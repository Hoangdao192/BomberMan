...
public class Kondoria extends Enemy {
    ...
    public Kondoria(int x, int y, int width, int height, Map map) {
    ...
    private void createAnimation() {
        ...
        Animation moveLeftAnimation = new Animation(
                ...
                Sprite.KONDORIA_MOVE_LEFT_1, Sprite.KONDORIA_MOVE_LEFT_2, Sprite.KONDORIA_MOVE_LEFT_3
        );

        Animation moveRightAnimation = new Animation(
                this, this.width, this.height, 2,
                Sprite.KONDORIA_MOVE_RIGHT_1, Sprite.KONDORIA_MOVE_RIGHT_2, Sprite.KONDORIA_MOVE_RIGHT_3
        );

        Animation dieAnimation = new Animation(
                this, this.width, this.height, 4,
                Sprite.KONDORIA_DIE, Sprite.ENEMY_DIE_1, Sprite.ENEMY_DIE_2, Sprite.ENEMY_DIE_3
        );
